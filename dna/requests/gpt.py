...
from dna.requests._media import build_openai_content
...
_key_pool = KeyPool(
    ...
    name="GPTKeyPool",
    empty_error="No OpenAI API keys configured. Add OPENAI_API_KEYS to dna/secrets.py.",
)
...
async def call_gpt(
    ...
    images sent at ``detail="low"`` (the resolution dna uses everywhere).
